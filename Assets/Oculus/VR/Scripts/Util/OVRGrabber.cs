...
public class OVRGrabber : MonoBehaviour
{
    ...
    protected virtual void MoveGrabbedObject(Vector3 pos, Quaternion rot, bool forceTeleport = false)
    {
        ...
        else
        {
            ...
            MotionScene.objs[m_grabbedObj.id][ctrl.frame].pos = MotionScene.objs[m_grabbedObj.id][0].obj.transform.position;
            MotionScene.objs[m_grabbedObj.id][ctrl.frame].rot = MotionScene.objs[m_grabbedObj.id][0].obj.transform.eulerAngles;
